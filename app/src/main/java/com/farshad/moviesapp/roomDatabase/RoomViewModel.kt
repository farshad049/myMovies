...
class RoomViewModel @Inject constructor(
    ...
    private val _favoriteMovieListMutableLiveData = MutableLiveData<List<FavoriteMovieEntity>>()
    val favoriteMovieListMutableLiveData : LiveData<List<FavoriteMovieEntity>> = _favoriteMovieListMutableLiveData
    ...
    fun getFavoriteMovieList(){
        viewModelScope.launch {
            repository.getAllFavoriteMovies().collectLatest {
                _favoriteMovieListMutableLiveData.postValue(it)
            }
        }
    }
